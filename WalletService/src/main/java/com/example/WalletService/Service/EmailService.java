...
public class EmailService
{
    ...
    public static  final String FROM_EMAIL = "roosh.06@gmail.com"; //requires valid gmail id
    public static final String PASSWORD = "roshan8980"; // correct password for gmail id

    public static void sendEmail(String toEmail)
    {
        //"toEmail" can be any email id
